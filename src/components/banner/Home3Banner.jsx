  ...
  return (
    <>
      <div className="home3-banner-section">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="banner-content">
                ...
                <h1>
                  From Idea to Revenue — Built with <span>Scalify</span> Solutions
                </h1>
                <p>
                  Scalify gives you everything you need to build and grow — from product design to full-scale development.
                  Hire us for one-time projects or get a dedicated team working 8 hours a day, just like your in-house crew.
                  We're your all-in-one digital partner — smart, scalable, and always on your side.
                </p>
                <ul>
                  <li>
                    <svg
        ...
        <img
          src="assets/img/home3/aipowered2.png"
          height={340}
          width={411}
          alt=""
        ...
        />
        <img
          src="assets/img/home3/analytics2.png"
          height={340}
          width={528}
          alt=""
        ...
        />
        <img
          src="assets/img/home3/tenpercent2.png"
          height={342}
          width={326}
          alt=""
