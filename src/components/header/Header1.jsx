          ...
          <div className="container d-flex align-items-center justify-content-between">
            <div className="sidebar-menu-logo">
              <Link href="/" className="logo-dark">
                <span
                  style={{ fontSize: "35px", fontWeight: 700, color: "black", position: "relative", top: "3px" }}
                >
                  Scalify Sol.
                </span>
              </Link>
              ...
              <div className="sidebar-menu-wrap">
                <ul className="main-menu">
                  ...
                  <li>
                    ...
                    <span
                      className={`dropdown-icon2 ${state.activeMenu === "case-study" ? "active" : ""
                        }`}
                    ...
                    <ul
                      className={`submenu-list ${state.activeMenu === "case-study" ? "d-block" : "d-none"
                        }`}
                    >
                      <li>
      ...
      >
        <div className="container d-flex flex-nowrap align-items-center justify-content-between">
          <div className="company-logo">
            <Link href="/" className="logo-dark">
              <span
                style={{ fontSize: "35px", fontWeight: 700, color: "white", position: "relative", top: "3px" }}
              >
                Scalify Sol.
              </span>
            </Link>
            ...
            <div className="right-sidebar-and-hotline-area">
              <div className="hotline-area d-xl-flex d-none">
                ...
                <div className="content">
                  ...
                  <h6>
                    <Link href="tel:+990737621432">+91-8222822708</Link>
                  </h6>
                </div>
              </div>
