...
const Header2 = () => {
  ...
  return (
    <>
          ...
          <div className="container d-flex align-items-center justify-content-between">
            <div className="sidebar-menu-logo">
              <Link href="/" className="logo-dark">
                <img src="/assets/logo/logo_black.svg" style={{ width: "18rem", marginRight: "1rem" }} />
              </Link>
              <Link href="/" className="logo-light">
                <img src="/assets/logo/logo_white.svg" style={{ width: "18rem", marginRight: "1rem" }} />
              </Link>
            </div>
                  ...
                  {navData.map((item) => (
                    <li key={item.id}>
                      ...
                      {item.subMenu && (
                        <>
                          <span
                            className={`dropdown-icon2 ${state.activeMenu === item.id ? "active" : ""
                              }`}
                          ...
                          <ul
                            className={`submenu-list ${state.activeMenu === item.id
                              ? "d-block"
                              : "d-none"
                              }`}
                          >
                  ...
                  <ul>
                    ...
                    <li className="single-contact">
                      ...
                      <div className="contact">
                        <span>Email Now</span>
                        <h6>
                          <a href="#">sales@scalifysolutions.com</a>
                        </h6>
                      </div>
                    </li>
                    <li className="single-contact">
      ...
      <header
        ref={headerRef}
        className={`z-50 header-area style-2 ${state.scrollY > 10 ? "sticky" : ""}`}
      >
        <div className="container d-flex flex-nowrap align-items-center justify-content-between">
          <div className="company-logo">
            <Link href="/" className="logo-dark">
              <span style={{ fontSize: "30px", fontWeight: 700, color: "white", position: "relative", top: "3px" }}>
                <img src="/assets/logo/logo.svg" style={{ width: "18rem", marginRight: "1rem" }} />
              </span>
            </Link>
            <Link href="/" className="logo-light">
              <span style={{ fontSize: "35px", fontWeight: 700, color: "white", position: "relative", top: "3px" }}>        Scalify Sol.</span>
            </Link>
          </div>
          <div className="main-menu d-lg-flex d-none">
            <ul className="menu-list">
              {navData.map((data) => {
                const { id, label, link, icon, subMenu, external } = data;
                return (
                  <li
                    key={id}
